<?php
/*
Copied from PEAR::DB library. Note the change on include/require lines
to include dirname(__FILE__) tacked on. (5 lines in all changed)

Be sure to remember to change these if upgrading this file to a newer version.
*/
