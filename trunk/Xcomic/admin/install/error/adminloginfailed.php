...
<div id="header">
	...
	<div id="title">Unable to verify admin login!</div>
</div>

<div id="main">
     <div id="description">
     <p>
     Xcomic was not able to verify the administrator login information you provided.
     In order to upgrade, you must provide the correct administrator username and password.
